...
Original file is located at
    https://colab.research.google.com/drive/1YzZSWgC2I1pZIWWBlDNTxB6tfRXux711
"""

!pip install streamlit yfinance scipy plotly fpdf requests pyngrok --quiet
...
# from utils.visualization import plot_efficient_frontier, plot_sector_allocation, plot_correlation_matrix
# from utils.metrics import display_metrics
# from utils.backtest import backtest_portfolio
...
# Commented out IPython magic to ensure Python compatibility.
# %%writefile utils/monte_carlo.py
# import numpy as np
# import pandas as pd
...
!streamlit run app.py --server.enableCORS=false --server.enableXsrfProtection=false --server.headless=true &>/content/log.txt &
!pkill ngrok

from pyngrok import ngrok
import time

ngrok.set_auth_token("39x7YWYZW1mRsMNEzKkqUKoqsTa_2KpcxoNEHBtt3tQ7HryQe")  # Remplacez par votre token ngrok
time.sleep(3)
public_url = ngrok.connect(8501)
print("Lien public vers l'application :", public_url)